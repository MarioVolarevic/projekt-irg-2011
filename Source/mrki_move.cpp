		...
		case (osgGA::GUIEventAdapter::KEYDOWN): 
			{
				...
				case osgGA::GUIEventAdapter::KEY_Down:
					voziloInputDeviceState->moveDwnRequest = true;
					return false;
		...
		case(osgGA::GUIEventAdapter::KEYUP):
			{
				...
				case osgGA::GUIEventAdapter::KEY_Right:
					...
					return false;
				case osgGA::GUIEventAdapter::KEY_Down:
					voziloInputDeviceState->moveDwnRequest = false;
					return false;
				case osgGA::GUIEventAdapter::KEY_Page_Up:
					voziloInputDeviceState->brzinaUp = false;
					return false;
				case osgGA::GUIEventAdapter::KEY_Page_Down:
...
public:
	...
	virtual void operator()(osg::Node* node, osg::NodeVisitor* nv)
	{
		...
		if (vmt)
		{
			...
			if(voziloInputDeviceState->rotRReq)
			{
				vmt->preMult(osg::Matrix::rotate(osg::inDegrees(-0.5f), osg::Z_AXIS));
			}
			if(voziloInputDeviceState->moveDwnRequest)
			{
